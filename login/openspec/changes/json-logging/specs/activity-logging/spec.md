...
- **WHEN** the logger flushes the current activity (e.g., when the active window changes or logging stops)
- **THEN** it SHALL append a JSON line containing "type": "activity", "timestamp_start", "timestamp_end", "window_title", "process_name", "username", "keystrokes", and "mouse_distance_px".
